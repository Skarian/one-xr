...
import io.onexr.HeadTrackingStreamDiagnostics
...
import io.onexr.XrSensorSnapshot
import io.onexr.XrSensorUpdateSource
import io.onexr.XrSessionState
import io.onexr.demo.databinding.ActivitySensorDemoBinding
...
class SensorDemoActivity : AppCompatActivity() {
    ...
    private fun attachClientCollectors(xrClient: OneXrClient) {
        cancelCollectors()
