...
class OneXrTrackerSampleMapperTest {
    ...
    fun fromReportPreservesGyroAndUsesLegacyAccelAxisOrderForTracker() {
        val report = OneXrReportMessage(
            ...
            imuId = 7,
            frameId = OneXrFrameId(byte0 = 1, byte1 = 2, byte2 = 3)
        )

        val sample = OneXrTrackerSampleMapper.fromReport(report)
    ...
    fun remapAccelBiasToTrackerFrameUsesLegacyAxisOrder() {
        val remapped = OneXrTrackerSampleMapper.remapAccelBiasToTrackerFrame(
            Vector3f(
                x = 1.0f,
                y = 2.0f,
                z = 3.0f
    ...
    fun remappedBiasSubtractionMatchesRawFrameThenRemapSemantics() {
        ...
        val mappedRaw = OneXrTrackerSampleMapper.remapAccelBiasToTrackerFrame(rawAccel)
        val mappedBias = OneXrTrackerSampleMapper.remapAccelBiasToTrackerFrame(rawBias)
        ...
        val correctedRawThenMapped = OneXrTrackerSampleMapper.remapAccelBiasToTrackerFrame(
            Vector3f(
